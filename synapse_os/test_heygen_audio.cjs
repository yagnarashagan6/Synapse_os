...
async function test() {
  ...
  try {
    const res = await axios.post("https://api.heygen.com/v2/video/generate", {
      title: "Test Audio",
      video_inputs: [{
        character: { type: "avatar", avatar_id: "Angela-inTshirt-20220820", avatar_style: "normal" },
        voice: { type: "audio", audio_url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3" },
